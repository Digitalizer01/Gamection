 ...
 * Use the [Session_Friends_add.newInstance] factory method to
 * create an instance of this fragment.
 */
class Session_Friends_add : Fragment() {
                        ...
                        try {
                            while (iterator.hasNext()) {
                                var variable_consulta: HashMap<HashMap<String, String>, HashMap<String, HashMap<String, String>>> =
                                    iterator.next().value as HashMap<HashMap<String, String>, HashMap<String, HashMap<String, String>>>
                                ...
                                for (i in 0..(keyarray.size - 1)) {
                                    var codigo_usuario = keyarray[i]
                                    if (id_usuario != codigo_usuario) {
                                        var hashMap_usuario: HashMap<String, String> =
                                            valuearray[i] as HashMap<String, String>
                                        var nombre_usuario: String? = hashMap_usuario.get("nombre")
                                        ...
                                        boton_anadir_amigo.setOnClickListener {
                                            Firebase.database("https://gamectiondb-default-rtdb.europe-west1.firebasedatabase.app/")
                                                ...
                                                .setValue(codigo_usuario)

                                            val toast =
                                                Toast.makeText(context, "Amigo agregado", Toast.LENGTH_SHORT)
    ...
    companion object {
         ...
         * @return A new instance of fragment Session_Friends_add.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Session_Friends_add().apply {
